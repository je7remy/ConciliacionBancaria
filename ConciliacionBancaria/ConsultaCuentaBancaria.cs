...
{
    public partial class ConsultaCuentaBancaria : Form
    {
        ...
        {
            if (MessageBox.Show("¿Estás seguro de que deseas cerrar la Consulta Cuenta Bancaria?", "Cerrar Consulta Cuenta Bancaria", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
            {
                e.Cancel = true;
            }
        }
