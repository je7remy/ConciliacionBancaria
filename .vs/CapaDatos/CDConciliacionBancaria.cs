...
using System.Data.Sql;
    ...
    namespace CapaDatos
    {
        ...
        // Método utilizado para obtener un DataTable con los datos de una conciliación bancaria por su ID
        public DataTable ObtenerConciliacionBancariaPorID(int conciliacionID)
        {
            try
            {
                ...
                // Se instancia un objeto de la clase CDConciliacionBancaria
                CDConciliacionBancaria objConciliacionBancaria = new CDConciliacionBancaria();

                // Se llena el DataTable con los datos de la conciliación bancaria correspondiente al ID proporcionado
                dt = objConciliacionBancaria.ObtenerConciliacionBancariaPorID(conciliacionID);
